...
<html lang="en">
    <head>
        ...
        <!-- C3 Chart css -->
        <link href="<?=$webroot;?>libs/c3/c3.min.css" rel="stylesheet" type="text/css" />

        <!-- App css -->
        <link href="<?=$webroot;?>css/bootstrap.min.css" rel="stylesheet" type="text/css" id="bootstrap-stylesheet" />
        <link href="<?=$webroot;?>css/icons.min.css" rel="stylesheet" type="text/css" />
        <link href="<?=$webroot;?>css/app.min.css" rel="stylesheet" type="text/css"  id="app-stylesheet" />
    ...
    <body>
            ...
            <div class="navbar-custom">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown notification-list dropdown d-none d-lg-inline-block ml-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?=$webroot;?>images/flags/germany.jpg" alt="lang-image" class="mr-1" height="12"> <span
                                    class="align-middle">German</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?=$webroot;?>images/flags/italy.jpg" alt="lang-image" class="mr-1" height="12"> <span
                                    class="align-middle">Italian</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?=$webroot;?>images/flags/spain.jpg" alt="lang-image" class="mr-1" height="12"> <span
                                    class="align-middle">Spanish</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?=$webroot;?>images/flags/russia.jpg" alt="lang-image" class="mr-1" height="12"> <span
                            ...
                            <div class="slimscroll noti-scroll">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon">
                                        <img src="<?=$webroot;?>images/users/avatar-4.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="<?=$webroot;?>images/users/avatar-1.jpg" alt="user-image" class="rounded-circle">
                ...
                <div class="logo-box">
                    <a href="index.html" class="logo text-center">
                        <span class="logo-lg">
                            <img src="<?=$webroot;?>images/logo-light.png" alt="" height="25">
                            <!-- <span class="logo-lg-text-light">UBold</span> -->
                        </span>
                        <span class="logo-sm">
                            <!-- <span class="logo-sm-text-dark">U</span> -->
                            <img src="<?=$webroot;?>images/logo-sm.png" alt="" height="28">
                        </span>
                    </a>
                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">SitiPagos Soft</h4>
                                </div>
                            </div>
                        </div>     
                        <div class="row">
        ...
        <div class="right-bar">
            ...
            <div class="slimscroll-menu">
                ...
                <div class="p-3">
                    ...
                    <div class="mb-2">
                        <img src="<?=$webroot;?>images/layouts/light.png" class="img-fluid img-thumbnail" alt="">
                    </div>
                    ...
                    <div class="mb-2">
                        <img src="<?=$webroot;?>images/layouts/dark.png" class="img-fluid img-thumbnail" alt="">
                    </div>
                    <div class="custom-control custom-switch mb-3">
                    ...
                    <div class="mb-2">
                        <img src="<?=$webroot;?>images/layouts/rtl.png" class="img-fluid img-thumbnail" alt="">
                    </div>
                    <div class="custom-control custom-switch mb-3">
                    ...
                    <div class="mb-2">
                        <img src="<?=$webroot;?>images/layouts/dark-rtl.png" class="img-fluid img-thumbnail" alt="">
                    </div>
                    <div class="custom-control custom-switch mb-5">
                        <input type="checkbox" class="custom-control-input theme-choice" id="dark-rtl-mode-switch" data-bsStyle="css/bootstrap-dark.min.css" 
                            data-appStyle="css/app-dark-rtl.min.css" />
        ...
        <!-- Vendor js -->
        <script src="<?=$webroot;?>js/vendor.min.js"></script>

        <!--C3 Chart-->
        <script src="<?=$webroot;?>libs/d3/d3.min.js"></script>
        <script src="<?=$webroot;?>libs/c3/c3.min.js"></script>

        <script src="<?=$webroot;?>libs/echarts/echarts.min.js"></script>

        <script src="<?=$webroot;?>js/pages/dashboard.init.js"></script>
