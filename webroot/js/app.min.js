...
!(function (t) {
    ...
    feather.replace({ "stroke-width": 1 }),
        t(document).on("click", '[data-toggle="fullscreen"]', function () {
            return (
                ...
                document.fullscreenEnabled ? (t(this).hasClass("active-fullscreen") ? document.documentElement.requestFullscreen() : document.exitFullscreen()) : alert("Your browser does not support fullscreen."),
                !1
            );
        }),
        ...
        t(document).on("click", "[data-nav-target]", function () {
            ...
            o.hasClass("navigation-toggle-one") && o.addClass("navigation-show"),
                t(".navigation .navigation-menu-body .navigation-menu-group > div").removeClass("open"),
                t(".navigation .navigation-menu-body .navigation-menu-group " + e).addClass("open"),
        ...
        t(document).on("click", ".navigation-toggler a", function () {
            return (
                n.width() < 1200
                    ...
                    : o.hasClass("navigation-toggle-one") || o.hasClass("navigation-toggle-two")
                    ? o.hasClass("navigation-toggle-one") && !o.hasClass("navigation-toggle-two")
                        ? (o.addClass("navigation-toggle-two"), o.removeClass("navigation-toggle-one"))
                        : !o.hasClass("navigation-toggle-one") && o.hasClass("navigation-toggle-two") && (o.removeClass("navigation-toggle-two"), o.removeClass("navigation-toggle-one"))
    ...
    if (
        (s.on("show.bs.dropdown", function (a) {
            ...
            i.css({ display: "block", top: e.top + t(a.target).outerHeight(), left: e.left, width: "184px", "font-size": "14px" }), i.addClass("mobPosDropdown");
        }),
        ...
        t(document).on("click", "*", function (a) {
            t(a.target).is(".chat-app-wrapper .chat-sidebar, .chat-app-wrapper .chat-sidebar *, .chat-app-wrapper .btn-chat-sidebar-open, .chat-app-wrapper .btn-chat-sidebar-open *") ||
        ...
        t(document).on("click", ".navigation ul li a", function () {
            ...
            if (a.next("ul").length) {
                ...
                return (
                    ...
                    a.parent("li").siblings().find("ul").not(a.parent("li").find("ul")).slideUp(200),
                    a.next("ul").find("li ul").slideUp(200),
                    a.next("ul").find("li>a").find(".sub-menu-arrow").removeClass("ti-minus").addClass("ti-plus"),
                    a.next("ul").find("li>a").find(".sub-menu-arrow").removeClass("rotate-in"),
                    a.parent("li").siblings().not(a.parent("li").find("ul")).find(">a").find(".sub-menu-arrow").removeClass("ti-minus").addClass("ti-plus"),
                    a.parent("li").siblings().not(a.parent("li").find("ul")).find(">a").find(".sub-menu-arrow").removeClass("rotate-in"),
    ...
    !o.hasClass("small-navigation") && !o.hasClass("horizontal-navigation") && !o.hasClass("hidden-navigation") && 992 <= n.width() && t(".navigation .navigation-menu-body").niceScroll(),
        ...
        t(document).on("click", ".chat-block .chat-content .mobile-chat-close-btn a", function () {
